 ...
 */function ImNotTouchingYou(e,t,i,n,s){return 0===OverlapArea(e,t,i,n,s)}function OverlapArea(e,t,i,n,s){var a,o,r,l,h=GetDimensions(e);if(t){var c=GetDimensions(t);o=c.height+c.offset.top-(h.offset.top+h.height);a=h.offset.top-c.offset.top;r=h.offset.left-c.offset.left;l=c.width+c.offset.left-(h.offset.left+h.width)}else{o=h.windowDims.height+h.windowDims.offset.top-(h.offset.top+h.height);a=h.offset.top-h.windowDims.offset.top;r=h.offset.left-h.windowDims.offset.left;l=h.windowDims.width-(h.offset.left+h.width)}o=s?0:Math.min(o,0);a=Math.min(a,0);r=Math.min(r,0);l=Math.min(l,0);return i?r+l:n?a+o:Math.sqrt(a*a+o*o+r*r+l*l)}
/**
 ...
 */function GetExplicitOffsets(e,t,i,n,s,a,o){var r=GetDimensions(e),l=t?GetDimensions(t):null;var h,c;if(null!==l){switch(i){case"top":h=l.offset.top-(r.height+s);break;case"bottom":h=l.offset.top+l.height+s;break;case"left":c=l.offset.left-(r.width+a);break;case"right":c=l.offset.left+l.width+a;break}switch(i){case"top":case"bottom":switch(n){case"left":c=l.offset.left+a;break;case"right":c=l.offset.left-r.width+l.width-a;break;case"center":c=o?a:l.offset.left+l.width/2-r.width/2+a;break}break;case"right":case"left":switch(n){case"bottom":h=l.offset.top-s+l.height-r.height;break;case"top":h=l.offset.top+s;break;case"center":h=l.offset.top+s+l.height/2-r.height/2;break}break}}return{top:h,left:c}}
/**
...
/**
   ...
   */
handleKey:function handleKey(t,i,n){var s,a,o,l=r[i],h=this.parseKey(t);if(!l)return console.warn("Component not defined!");if(true!==t.zfIsKeyHandled){s="undefined"===typeof l.ltr?l:rtl()?e.extend({},l.ltr,l.rtl):e.extend({},l.rtl,l.ltr);a=s[h];o=n[a];if(o&&"function"===typeof o){var c=o.apply();t.zfIsKeyHandled=true;(n.handled||"function"===typeof n.handled)&&n.handled(c)}else(n.unhandled||"function"===typeof n.unhandled)&&n.unhandled()}},
/**
...
/**
   ...
   */
releaseFocus:function releaseFocus(e){e.off("keydown.zf.trapfocus")}};function getKeyCodes(e){var t={};for(var i in e)e.hasOwnProperty(i)&&(t[e[i]]=e[i]);return t}var h=["mui-enter","mui-leave"];var c=["mui-enter-active","mui-leave-active"];var u={animateIn:function animateIn(e,t,i){animate(true,e,t,i)},animateOut:function animateOut(e,t,i){animate(false,e,t,i)}};function Move(e,t,i){var n,s,a=null;if(0!==e)n=window.requestAnimationFrame(move);else{i.apply(t);t.trigger("finished.zf.animate",[t]).triggerHandler("finished.zf.animate",[t])}function move(o){a||(a=o);s=o-a;i.apply(t);if(s<e)n=window.requestAnimationFrame(move,t);else{window.cancelAnimationFrame(n);t.trigger("finished.zf.animate",[t]).triggerHandler("finished.zf.animate",[t])}}}
/**
...
/**
     ...
     * @param {String[]} [failedValidators] - List of failed validators.
     */},{key:"addErrorClasses",value:function addErrorClasses(e,t){var i=this.findLabel(e);var n=this.findFormError(e,t);i.length&&i.addClass(this.options.labelErrorClass);n.length&&n.addClass(this.options.formErrorClass);e.addClass(this.options.inputErrorClass).attr({"data-invalid":"","aria-invalid":true})}
/**
     * Adds [for] and [role=alert] attributes to all form error targetting $el,
     * and [aria-describedby] attribute to $el toward the first form error.
     * @param {Object} $el - jQuery object
     */},{key:"addA11yAttributes",value:function addA11yAttributes(t){var i=this.findFormError(t);var n=i.filter("label");var s=i.first();if(i.length){if("undefined"===typeof t.attr("aria-describedby")){var a=s.attr("id");if("undefined"===typeof a){a=GetYoDigits(6,"abide-error");s.attr("id",a)}t.attr("aria-describedby",a)}if(n.filter("[for]").length<n.length){var o=t.attr("id");if("undefined"===typeof o){o=GetYoDigits(6,"abide-input");t.attr("id",o)}n.each((function(t,i){var n=e(i);"undefined"===typeof n.attr("for")&&n.attr("for",o)}))}i.each((function(t,i){var n=e(i);"undefined"===typeof n.attr("role")&&n.attr("role","alert")})).end()}}
/**
...
/**
   ...
   * @default 0
   */
hOffset:0};var H=function(t){_inherits(Dropdown,t);var i=_createSuper(Dropdown);function Dropdown(){_classCallCheck(this,Dropdown);return i.apply(this,arguments)}_createClass(Dropdown,[{key:"_setup",value:
/**
...
/**
     ...
     */},{key:"getHeightsByRow",value:function getHeightsByRow(t){var i=this.$watched.length?this.$watched.first().offset().top:0,n=[],s=0;n[s]=[];for(var a=0,o=this.$watched.length;a<o;a++){this.$watched[a].style.height="auto";var r=e(this.$watched[a]).offset().top;if(r!==i){s++;n[s]=[];i=r}n[s].push([this.$watched[a],this.$watched[a].offsetHeight])}for(var l=0,h=n.length;l<h;l++){var c=e(n[l]).map((function(){return this[1]})).get();var u=Math.max.apply(null,c);n[l].push(u)}t(n)}
/**
...
/**
    ...
    */},{key:"changeSlide",value:function changeSlide(e,t,i){if(this.$slides){var n=this.$slides.filter(".is-active").eq(0);if(/mui/g.test(n[0].className))return false;var s,a=this.$slides.first(),o=this.$slides.last(),r=e?"Right":"Left",l=e?"Left":"Right",h=this;s=t||(e?this.options.infiniteWrap?n.next(".".concat(this.options.slideClass)).length?n.next(".".concat(this.options.slideClass)):a:n.next(".".concat(this.options.slideClass)):this.options.infiniteWrap?n.prev(".".concat(this.options.slideClass)).length?n.prev(".".concat(this.options.slideClass)):o:n.prev(".".concat(this.options.slideClass)));if(s.length){this.$element.trigger("beforeslidechange.zf.orbit",[n,s]);if(this.options.bullets){i=i||this.$slides.index(s);this._updateBullets(i)}if(this.options.useMUI&&!this.$element.is(":hidden")){u.animateIn(s.addClass("is-active"),this.options["animInFrom".concat(r)],(function(){s.css({display:"block"}).attr("aria-live","polite")}));u.animateOut(n.removeClass("is-active"),this.options["animOutTo".concat(l)],(function(){n.removeAttr("aria-live");h.options.autoPlay&&!h.timer.isPaused&&h.timer.restart()}))}else{n.removeClass("is-active is-in").removeAttr("aria-live").hide();s.addClass("is-active is-in").attr("aria-live","polite").show();this.options.autoPlay&&!this.timer.isPaused&&this.timer.restart()}this.$element.trigger("slidechange.zf.orbit",[s])}}}
/**
...
/**
     ...
     */},{key:"_setHandlePos",value:function _setHandlePos(e,t,i){if(!this.$element.hasClass(this.options.disabledClass)){t=parseFloat(t);t<this.options.start?t=this.options.start:t>this.options.end&&(t=this.options.end);var n=this.options.doubleSided;if(n)if(0===this.handles.index(e)){var s=parseFloat(this.$handle2.attr("aria-valuenow"));t=t>=s?s-this.options.step:t}else{var a=parseFloat(this.$handle.attr("aria-valuenow"));t=t<=a?a+this.options.step:t}var o=this,r=this.options.vertical,l=r?"height":"width",h=r?"top":"left",c=e[0].getBoundingClientRect()[l],u=this.$element[0].getBoundingClientRect()[l],d=this._pctOfBar(t),f=(u-c)*d,p=(100*percent(f,u)).toFixed(this.options.decimal);t=parseFloat(t.toFixed(this.options.decimal));var v={};this._setValues(e,t);if(n){var g,m=0===this.handles.index(e),y=Math.floor(100*percent(c,u));if(m){v[h]="".concat(p,"%");g=parseFloat(this.$handle2[0].style[h])-p+y;i&&"function"===typeof i&&i()}else{var _=parseFloat(this.$handle[0].style[h]);g=p-(isNaN(_)?(this.options.initialStart-this.options.start)/((this.options.end-this.options.start)/100):_)+y}v["min-".concat(l)]="".concat(g,"%")}var b=this.$element.data("dragging")?1e3/60:this.options.moveTime;Move(b,e,(function(){isNaN(p)?e.css(h,"".concat(100*d,"%")):e.css(h,"".concat(p,"%"));o.options.doubleSided?o.$fill.css(v):o.$fill.css(l,"".concat(100*d,"%"))}));if(this.initialized){this.$element.one("finished.zf.animate",(function(){o.$element.trigger("moved.zf.slider",[e])}));clearTimeout(o.timeout);o.timeout=setTimeout((function(){o.$element.trigger("changed.zf.slider",[e])}),o.options.changedDelay)}}}
/**
...
/**
     ...
     */},{key:"_handleEvent",value:function _handleEvent(t,i,n){var s;if(n)s=this._adjustValue(null,n);else{t.preventDefault();var a=this,o=this.options.vertical,r=o?"height":"width",l=o?"top":"left",h=o?t.pageY:t.pageX,c=this.$element[0].getBoundingClientRect()[r],u=o?e(window).scrollTop():e(window).scrollLeft();var d=this.$element.offset()[l];t.clientY===t.pageY&&(h+=u);var f=h-d;var p;p=f<0?0:f>c?c:f;var v=percent(p,c);s=this._value(v);rtl()&&!this.options.vertical&&(s=this.options.end-s);s=a._adjustValue(null,s);if(!i){var g=absPosition(this.$handle,l,p,r),m=absPosition(this.$handle2,l,p,r);i=g<=m?this.$handle:this.$handle2}}this._setHandlePos(i,s)}
/**
